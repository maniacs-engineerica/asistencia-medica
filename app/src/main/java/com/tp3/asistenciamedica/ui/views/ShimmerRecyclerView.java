...
public class ShimmerRecyclerView extends RecyclerView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            setDemoLayoutReference(a.getResourceId(R.styleable.ShimmerRecyclerView_shimmer_demo_layout, R.layout.shimmer_type_1));
            ...
            mShimmerColor = a.getColor(R.styleable.ShimmerRecyclerView_shimmer_demo_shimmer_color, Color.GRAY);
    ...
    public boolean isShimmering(){
        return getAdapter() == mShimmerAdapter;
    }
    ...
    public void setDemoShimmerColor(int shimmerColor) {
        mShimmerAdapter.setShimmerColor(shimmerColor);
    }

    public void setDemoShimmerAngle(int shimmerAngle) {
        mShimmerAdapter.setShimmerAngle(shimmerAngle);
    }

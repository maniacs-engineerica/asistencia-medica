...
class TurnosAdapter(var turnosList: MutableList<Turno>,
                    val onItemClick:(Int) -> Unit) : RecyclerView.Adapter<TurnosAdapter.TurnoHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TurnosAdapter.TurnoHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.nuevoturno_turnosdisp,parent,false)

        return (TurnoHolder(view))

    }

    override fun onBindViewHolder(holder: TurnosAdapter.TurnoHolder, position: Int) {
